...
A comprehensive Python controller for the Anki Cozmo (version 1) robot, built on [pycozmo](https://github.com/zayfod/pycozmo) with custom patches and an extended scripting language.
